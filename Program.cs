    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (codeWord != "5")
            {
                ...
                {
                    case "1":
                        AddPerson(ref indexAndFullName, ref post);
                        break;
                    case "2":
                        ShowDossier(indexAndFullName, post);
                        break;
                    case "3":
                        DeleteDossier(ref indexAndFullName, ref post);
                        break;
                    case "4":
                        FindPerson(indexAndFullName, post);
                        break;
                }
            }
        }
